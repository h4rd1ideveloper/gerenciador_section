		...
		class Kirki_Installer_Section extends WP_Customize_Section {
			...
			protected function render() {
                ...
                <li id="accordion-section-<?php echo esc_attr( $this->id ); ?>"
					...
					<?php if ( ! $installed ) : ?>
                        <p style="text-align:left;margin-top:0;"><?php esc_attr_e( 'Please install the Kirki plugin to take full advantage of this theme\s customizer capabilities', 'verthos' ); ?></p>
                        <a class="install-now button-primary button" data-slug="kirki"
                           href="<?php echo esc_url_raw( $plugin_install_url ); ?>"
                           aria-label="<?php esc_attr_e( 'Install Kirki Toolkit now', 'verthos' ); ?>"
                           data-name="Kirki Toolkit">
							<?php esc_html_e( 'Install Now', 'verthos' ); ?>
                        </a>
					<?php else : ?>
                        <p style="text-align:left;margin-top:0;"><?php esc_attr_e( 'You have installed Kirki. Activate it to take advantage of this theme\'s features in the customizer.', 'verthos' ); ?></p>
                        <a class="install-now button-secondary button change-theme" data-slug="kirki"
                           ...
                           aria-label="<?php esc_attr_e( 'Activate Kirki Toolkit now', 'verthos' ); ?>"
                           data-name="Kirki Toolkit">
							<?php esc_html_e( 'Activate Now', 'verthos' ); ?>
                        </a>
					<?php endif; ?>
                </li>
				<?php
